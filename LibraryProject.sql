...
INSERT INTO tbl_loans
		...
		(12, 1, 105, '2017-10-11', '2017-11-01'),
		(1, 1, 106, '2017-10-11', '2017-11-01'),
		(2, 1, 107, '2017-10-11', '2017-11-01'),
		(3, 1, 108, '2017-10-11', '2017-11-01'),
		(4, 1, 109, '2017-10-11', '2017-11-01'),
		(5, 1, 110, '2017-10-11', '2017-11-01'),
		(6, 1, 111, '2017-10-11', '2017-11-01'),
		(7, 1, 104, '2017-10-11', '2017-11-01'),
		(8, 1, 105, '2017-10-11', '2017-11-01'),
		(9, 1, 106, '2017-10-11', '2017-11-01'),
		(10, 1, 107, '2017-10-11', '2017-11-01'),
		(2, 1, 108, '2017-10-11', '2017-11-01'),
		(12, 1, 109, '2017-10-11', '2017-11-01'),
		(1, 2, 110, '2017-09-21', '2017-10-11'),
		(2, 2, 111, '2017-09-21', '2017-10-11'),
		(3, 2, 104, '2017-09-21', '2017-10-11'),
		(4, 2, 105, '2017-09-21', '2017-10-11'),
		(5, 2, 106, '2017-09-21', '2017-10-11'),
		(6, 2, 107, '2017-09-21', '2017-10-11'),
		(7, 2, 108, '2017-09-21', '2017-10-11'),
		(8, 2, 109, '2017-09-21', '2017-10-11'),
		(9, 2, 110, '2017-09-21', '2017-10-11'),
		(10, 2, 111, '2017-09-21', '2017-10-11'),
		(2, 2, 104, '2017-09-21', '2017-10-11'),
		(12, 2, 105, '2017-09-28', '2017-10-18'),
		(11, 3, 106, '2017-09-28', '2017-10-18'),
		(12, 3, 107, '2017-09-28', '2017-10-18'),
		(13, 3, 108, '2017-09-28', '2017-10-18'),
		(14, 3, 109, '2017-09-28', '2017-10-18'),
		(15, 3, 110, '2017-09-28', '2017-10-18'),
		(16, 3, 111, '2017-09-28', '2017-10-18'),
		(17, 3, 104, '2017-09-28', '2017-10-18'),
		(18, 3, 105, '2017-09-28', '2017-10-18'),
		(19, 3, 106, '2017-09-28', '2017-10-18'),
		(20, 3, 107, '2017-09-28', '2017-10-18'),
		(2, 3, 108, '2017-09-28', '2017-10-18'),
		(12, 3, 109, '2017-09-28', '2017-10-18'),
		(11, 4, 110, '2017-10-07', '2017-10-27'),
		(12, 4, 111, '2017-10-07', '2017-10-27'),
		(13, 4, 104, '2017-10-07', '2017-10-27'),
		(14, 4, 105, '2017-10-07', '2017-10-27'),
		(15, 4, 106, '2017-10-07', '2017-10-27'),
		(16, 4, 107, '2017-10-07', '2017-10-27'),
		(17, 4, 108, '2017-10-07', '2017-10-27'),
		(18, 4, 109, '2017-10-07', '2017-10-27'),
		(19, 4, 110, '2017-10-07', '2017-10-27'),
		(20, 4, 111, '2017-10-07', '2017-10-27'),
		(11, 1, 104, '2017-10-07', '2017-10-27'),
		(12, 1, 105, '2017-10-07', '2017-10-27'),
		(13, 1, 106, '2017-10-07', '2017-10-27'),
		(14, 1, 107, '2017-10-07', '2017-10-27'),
		(15, 1, 108, '2017-10-07', '2017-10-27'),
		(16, 1, 109, '2017-10-07', '2017-10-27'),
		(17, 1, 110, '2017-10-07', '2017-10-27'),
		(18, 1, 111, '2017-10-07', '2017-10-27'),
		(19, 1, 104, '2017-10-07', '2017-10-27'),
		(20, 1, 105, '2017-10-07', '2017-10-27'),
		(11, 1, 104, '2017-10-07', '2017-10-27'),
		(12, 1, 105, '2017-10-07', '2017-10-27'),
		(13, 1, 106, '2017-10-07', '2017-10-27'),
		(14, 1, 107, '2017-10-07', '2017-10-27'),
...
/**** SELECT STATEMENTS FOR DRILLS ****/
	...
	SELECT
		...
		WHERE tbl_borrower.borrower_cardNO = NULL
	;
	...
	SELECT 
		b1.book_title, b2.borrower_name, b2.borrower_address
		FROM tbl_loans l 
		LEFT JOIN tbl_book b1 ON b1.book_id = l.loans_bookId
		LEFT JOIN tbl_borrower b2 ON b2.borrower_cardNO = l.loans_cardNo
		WHERE l.loans_dateDue <= '2017-10-11'
	;
	...
	SELECT branch_name, COUNT(loans_dateOut) AS 'TOTAL LOANS'
		...
		WHERE tbl_branch.branch_name = 'sharpstown'
		GROUP BY branch_name, loans_dateOut
	;
	...
	/**** 7. For each book authored (or co-authored) by "Stephen King", retrieve the title and the number of copies owned by the library branch whose name is "Central". ANSWER: ****/
		...
		SELECT book_title, SUM(copies_noCopies)
			FROM tbl_book b1 
			...
			WHERE b2.branch_name = 'central'
			GROUP BY book_title, Authors_name, copies_noCopies
			HAVING a.Authors_name = 'Stephen King'
		; 